...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign In' link to open the login page and inspect the username and password fields.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/main/div/header/div/div[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the username field with 'admin' then the password field with the provided secret and submit the form.
        frame = context.pages[-1]
        # Input text
