...
async def run_test():
    ...
    try:
        ...
        # -> Open the login form by clicking 'Sign In', then submit admin credentials.
        ...
        # -> Dismiss the guided tour popup by clicking 'Skip', then click 'Devices' in the sidebar to open the /devices page, and wait for it to load.
        frame = context.pages[-1]
        # Click element
        ...
        # -> Click the 'TestCo' device name link in the devices table to open its detail page (/devices/:id) and then verify device info fields and sections.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/main/div/div[3]/div/table/tbody/tr/td[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
