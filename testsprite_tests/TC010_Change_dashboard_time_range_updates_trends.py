...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Last 7 days')]").nth(0).is_visible(), "The trend charts should reflect the selected Last 7 days time range after changing the dashboard filter.",
        assert await frame.locator("xpath=//*[contains(., 'Recent activity')]").nth(0).is_visible(), "The recent activity section should update to reflect the selected time range."]}
