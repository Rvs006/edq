...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields with admin credentials and submit the form to sign in.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Wait for the login to complete and then navigate to http://localhost:3000/review to verify the review queue page loads and shows either a table of pending reviews or an empty-state message.
