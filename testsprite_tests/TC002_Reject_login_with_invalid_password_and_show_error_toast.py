...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login and wait for the login form to appear so I can fill the username and wrong password.
        await page.goto("http://localhost:3000/login")
        
        # -> Fill username 'admin' and password 'wrongpassword123', click 'Sign In', wait for UI feedback, then check for an 'Invalid credentials' error toast and confirm the URL remains on /login. After verification, finish the test.
