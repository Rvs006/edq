...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the app's login page at http://localhost:5174/login and wait for the page to load so I can fill the credentials.
        await page.goto("http://localhost:5174/login")
        
        # -> Enter the username into the username field (index 155).
        ...
        # -> Click the 'Sign In' button (index 159) to submit the login form, then wait for the app to load the dashboard and show a dashboard-specific element.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/main/div/div[3]/div/div[2]/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
