...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the application's /login page (use localhost:5174/login per preview info) and wait for the page to load so the login form can be interacted with.
        await page.goto("http://localhost:5174/login")
        
        # -> Fill the username and password fields with the invalid credentials, submit the form, and wait for the UI response.
