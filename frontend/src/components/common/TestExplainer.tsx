...
const TEST_EXPLAINERS: Record<string, { what: string; why: string; pass: string; fail: string }> = {
  ...
  U04: {
    what: 'Runs the EDQ DHCP harness on an isolated segment and checks whether the device accepts the offered lease.',
    why: 'The qualification requires the device to take its IP, DNS, and NTP settings from the tester-hosted DHCP service.',
    pass: 'DHCP lease confirmed — device accepted EDQ DHCP address, DNS, and NTP options.',
    fail: 'Could not confirm EDQ DHCP lease acceptance — check the harness offer settings and device network settings.',
  },
  U05: {
  ...
  U13: {
    what: 'Retired standalone check. HSTS evidence is now reviewed with U35.',
    why: 'Combining web header findings keeps related HTTP/web server issues in one result.',
    pass: 'Handled by U35.',
    fail: 'Handled by U35.',
  },
  U14: {
    what: 'Retired standalone check. HTTP security headers are now reviewed with U35.',
    why: 'Combining web header findings keeps related HTTP/web server issues in one result.',
    pass: 'Handled by U35.',
    fail: 'Handled by U35.',
  },
  ...
  U35: {
    what: 'Runs Nikto and captures HTTP response headers against the device HTTP/HTTPS service.',
    why: 'Web interfaces often have missing security headers, misconfigurations, outdated software, or known vulnerabilities.',
    pass: 'No significant web server or HTTP header issues found.',
    fail: 'Web/header issues found — review findings and patch or reconfigure the web server.',
  },
  U36: {
