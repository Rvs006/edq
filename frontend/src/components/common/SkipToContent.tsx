...
export default function SkipToContent() {
  ...
  return (
    <a
      href="#main-content"
      onClick={handleClick}
      className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[200] focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:bg-brand-500 focus:text-white focus:rounded-lg focus:outline-hidden focus:ring-2 focus:ring-brand-500/50 focus:shadow-lg transition-all"
    >
