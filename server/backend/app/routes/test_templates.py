...
from app.utils.collections import dedupe_preserving_order
...
async def create_template(
    ...
    if "test_ids" in clean and clean["test_ids"]:
        clean["test_ids"] = dedupe_preserving_order(clean["test_ids"])
...
async def update_template(
    ...
    if "test_ids" in updates:
        template.test_ids = dedupe_preserving_order(updates["test_ids"])
